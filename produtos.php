...
<main>
    ...
    <div class="filtros">
        <a href="produtos.php" class="filtro-btn">Todos</a>
        <?php foreach($categorias as $c): ?>
            <a href="produtos.php?categoria=<?= urlencode($c['categoria']) ?>" class="filtro-btn"><?= htmlspecialchars($c['categoria']) ?></a>
        <?php endforeach; ?>
    </div>
    <div class="produtos-grid">
        <?php foreach ($produtos as $p): ?>
            <div class="produto-card">
                ...
                <span class="categoria"><?= htmlspecialchars($p['categoria']) ?></span>
